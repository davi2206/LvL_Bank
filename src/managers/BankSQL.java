...
public class BankSQL implements BankManagement
{
	private DbConnection dbCon;
	private Registration reg;
	private Plugin plugin;
	private static BankSQL bankMan;
	...
	private BankSQL(DbConnection dbCon, Plugin plugin)
	{
	...
	// XXX Get instance
	public static BankSQL getInstance(DbConnection dbCon, Plugin plugin)
	{
		if (bankMan == null)
		{
			bankMan = new BankSQL(dbCon, plugin);
		}
		return bankMan;
	}
	...
	//XXX Check if the withdrawn amount is within the limits
	@Override
	...
	{
		cs.sendMessage(ChatColor.RED + "There seems to be a problem with the connection to the bank servers.");
	}
